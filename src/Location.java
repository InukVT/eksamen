public class Location {
    ...
    static Location roomH = new Location("You're somewhere...? Nothing seems of interest here.. But you do see a corridor to your north and to your east"); //just a corridor
    ...
    static Location roomT = new Location("You're at the Armoury. You see a lot boxes and cargos loaded with sharp blades and fire arms. West from here you see a corridor leading deeper into the Armoury and east from here you see a corridor that seems to lead you deeper into the Sinister part of the labyrinth"); //Village
    ...
    public Location () {
        ...
        Location.roomWeap.item = Item.generateAllItems().get(5);
